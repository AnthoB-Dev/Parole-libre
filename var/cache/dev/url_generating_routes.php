...
return [
    ...
    'app_category_article' => [['categorySlug', 'id', 'titleSlug'], ['_controller' => 'App\\Controller\\BlogController::showArticle'], [], [['variable', '/', '[^/]++', 'titleSlug', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/article'], ['variable', '/', '[^/]++', 'categorySlug', true]], [], [], []],
