...
return [
    ...
    'app_comment_del' => [['categorySlug', 'id', 'commentId'], ['_controller' => 'App\\Controller\\BlogController::delComment'], [], [['variable', '/', '[^/]++', 'commentId', true], ['text', '/del-comment'], ['variable', '/', '[^/]++', 'id', true], ['text', '/article'], ['variable', '/', '[^/]++', 'categorySlug', true]], [], [], []],
