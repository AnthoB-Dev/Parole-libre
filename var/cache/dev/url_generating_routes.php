...
return [
    ...
    'app_category_politique' => [[], ['_controller' => 'App\\Controller\\BlogController::politique'], [], [['text', '/politique']], [], [], []],
    'app_category_economie' => [[], ['_controller' => 'App\\Controller\\BlogController::economie'], [], [['text', '/economie']], [], [], []],
    'app_category_geopolitique' => [[], ['_controller' => 'App\\Controller\\BlogController::geopolitique'], [], [['text', '/geopolitique']], [], [], []],
    'app_category_societe' => [[], ['_controller' => 'App\\Controller\\BlogController::societe'], [], [['text', '/societe']], [], [], []],
    'app_category_artsLitteratures' => [[], ['_controller' => 'App\\Controller\\BlogController::artsLitteratures'], [], [['text', '/arts-litteratures']], [], [], []],
    'app_category_paroleLibre' => [[], ['_controller' => 'App\\Controller\\BlogController::paroleLibre'], [], [['text', '/parole-libre']], [], [], []],
    'app_category_article' => [['category', 'id'], ['_controller' => 'App\\Controller\\BlogController::showArticle'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/article'], ['variable', '/', '[^/]++', 'category', true]], [], [], []],
