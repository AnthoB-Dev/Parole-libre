...
return [
    ...
    'app_category_article_update_comment' => [['categorySlug', 'id', 'commentId'], ['_controller' => 'App\\Controller\\BlogController::updateComment'], [], [['text', '/update'], ['variable', '/', '[^/]++', 'commentId', true], ['text', '/comment'], ['variable', '/', '[^/]++', 'id', true], ['text', '/article'], ['variable', '/', '[^/]++', 'categorySlug', true]], [], [], []],
